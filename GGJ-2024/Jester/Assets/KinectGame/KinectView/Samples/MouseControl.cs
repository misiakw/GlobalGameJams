...
//			if(debugText)
//			{
//				if(!debugText.GetComponent<UnityEngine.UI.Text>().text.Contains("ScrPos"))
//				{
//					debugText.GetComponent<UnityEngine.UI.Text>().text += string.Format(", ScrSize: ({0}, {1}), WinSize: ({2}, {3}), WinPos: ({4}, {5}), ScrPos: ({6:F0}, {7:F0})", 
